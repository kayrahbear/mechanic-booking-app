...
class NHTSAService:
    ...
    def _get_fallback_models(self, make_name: str) -> List[Dict[str, str]]:
        ...
        fallback_models = {
            "Honda": [
                {"Model_ID": 1, "Model_Name": "Accord", "Make_ID": 9, "Make_Name": "Honda"},
                {"Model_ID": 2, "Model_Name": "Civic", "Make_ID": 9, "Make_Name": "Honda"},
                {"Model_ID": 3, "Model_Name": "CR-V", "Make_ID": 9, "Make_Name": "Honda"},
                {"Model_ID": 4, "Model_Name": "Pilot", "Make_ID": 9, "Make_Name": "Honda"},
                {"Model_ID": 5, "Model_Name": "Odyssey", "Make_ID": 9, "Make_Name": "Honda"},
            ],
            "Toyota": [
                {"Model_ID": 1, "Model_Name": "Camry", "Make_ID": 22, "Make_Name": "Toyota"},
                {"Model_ID": 2, "Model_Name": "Corolla", "Make_ID": 22, "Make_Name": "Toyota"},
                {"Model_ID": 3, "Model_Name": "RAV4", "Make_ID": 22, "Make_Name": "Toyota"},
                {"Model_ID": 4, "Model_Name": "Highlander", "Make_ID": 22, "Make_Name": "Toyota"},
                {"Model_ID": 5, "Model_Name": "Prius", "Make_ID": 22, "Make_Name": "Toyota"},
            ],
            "Ford": [
                {"Model_ID": 1, "Model_Name": "F-150", "Make_ID": 7, "Make_Name": "Ford"},
                {"Model_ID": 2, "Model_Name": "Escape", "Make_ID": 7, "Make_Name": "Ford"},
                {"Model_ID": 3, "Model_Name": "Explorer", "Make_ID": 7, "Make_Name": "Ford"},
                {"Model_ID": 4, "Model_Name": "Mustang", "Make_ID": 7, "Make_Name": "Ford"},
                {"Model_ID": 5, "Model_Name": "Focus", "Make_ID": 7, "Make_Name": "Ford"},
            ],
            "Chevrolet": [
                {"Model_ID": 1, "Model_Name": "Silverado", "Make_ID": 4, "Make_Name": "Chevrolet"},
                {"Model_ID": 2, "Model_Name": "Equinox", "Make_ID": 4, "Make_Name": "Chevrolet"},
                {"Model_ID": 3, "Model_Name": "Malibu", "Make_ID": 4, "Make_Name": "Chevrolet"},
                {"Model_ID": 4, "Model_Name": "Tahoe", "Make_ID": 4, "Make_Name": "Chevrolet"},
                {"Model_ID": 5, "Model_Name": "Cruze", "Make_ID": 4, "Make_Name": "Chevrolet"},
            ],
        }
